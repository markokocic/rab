use crate::Component;
use crate::component::{RenderCache, RenderCacheKey};
use crate::overlay::{OverlayEntry, OverlayLayout, OverlayOptions, SizeValue};
use crate::util::{extract_segments, slice_by_column, visible_width};
...
impl Container {
    ...
    pub fn hide_overlay(&mut self, id: u64) -> Option<crate::FocusTarget> {
    ...
    /// with that overlay, so the TUI can restore focus.
    pub fn pop_overlay(&mut self) -> Option<crate::FocusTarget> {
...
impl Container {
    ...
    fn resolve_anchor_row(
        anchor: crate::overlay::OverlayAnchor,
        overlay_height: usize,
        avail_height: usize,
        margin_top: usize,
    ) -> usize {
