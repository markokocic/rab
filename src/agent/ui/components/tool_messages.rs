...
impl ToolExecComponent {
    ...
    fn render_with_renderer(
        ...
        // Pi-style: Spacer(1) before every tool execution (provides a blank
        // line separator with no background, visually distinct from the
        // TuiBox's padding_y top line which carries the box background).
